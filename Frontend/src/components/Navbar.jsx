...
import logo from "../assets/LifelinkAI_logo.jpg";
...
function Navbar() {
  ...
  const isLoggedIn =
    userInfo?.data?.username || userInfo?.data?.user?.username;
    ...
    <nav className="navbar">
      ...
      <div className="navbar-logo">
        <NavLink to="/" className="navbar-brand" onClick={handleLinkClick}>
          <img src={logo} alt="LifelinkAI" />
          <span className="navbar-brand-name">LifelinkAI</span>
        </NavLink>
      </div>
